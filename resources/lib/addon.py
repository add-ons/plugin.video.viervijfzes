...
@routing.route('/play/catalog/<channel>/<item>')
def play(channel, item):
    """ Play the requested item """
    from resources.lib.modules.player import Player
    Player().play(channel, item)


@routing.route('/play/page/<channel>/<item>')
def play_from_page(channel, item):
    """ Play the requested item """
    try:  # Python 3
    ...
    from resources.lib.modules.player import Player
    Player().play_from_page(channel, unquote(item))
